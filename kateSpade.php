...
<style>
  #panel-7 .thumbnail-overlay{display: block;}
</style>
<?php require_once 'subHeader02.php';?>
...
<div class="frame">
  ...
  <div class="bit-1">
    <div class="project-btn" id="project">
      <a href="http://www.fastcocreate.com/3021852/kate-spade-new-york-gives-the-banner-a-purpose-with-this-shoppable-video-ad" target="_blank">Press Article</a>
    </div>
  </div>
  ...
  <div class="bit-1">
    <div class="work04" id="project">
      <p>End screen.jpg</p>
      <img class="projectTab" style="border-style: none;" src='img/assets/browserTab.png'>
      <img src='img/projects/KateSpade/ks05.jpg'>
    </div>
  </div>
