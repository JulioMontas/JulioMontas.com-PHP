...
<style>#panel-11 .thumbnail-overlay{display: block;}</style>
...
<div class="frame">
  ...
  <div class="bit-1">
    <div class="project-btn" id="project">
      <a href="http://catchsuperman.juliomontas.com/" target="_blank">Visit the site</a>
    </div>
  </div>
  ...
  <div class="bit-1">
    <div class="work03 languageDetails" id="project">
      <ul>
        <li><b>Processing:</b>100%</li>
      </ul>
      <a href="https://github.com/JulioMontas/CatchMe_0.1" target="_blank">View the code</a>
    </div>
  </div>
