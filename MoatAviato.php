...
<style>#panel-21 .thumbnail-overlay{display: block;}</style>
...
<div class="frame">
  ...
  <div class="bit-1">
    <div class="project-btn" id="project">
      <a href="http://invis.io/ED3IUDZUQ" target="_blank">InVision Prototype</a>
    </div>
  </div>
  ...
  <div class="bit-1">
    <div class="work01" id="project">
      <h3>
        I designed a web app that provides users with options of which type of air travel they would like to use (commercial airplane, helicopter, private jet). The app then finds the airport closest to the user by using GPS data. Ultimately, this app would be used to plan and book trips from airport to airport.
      </h3>
   </div>
  </div>
