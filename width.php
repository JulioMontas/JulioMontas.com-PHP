...
<?php require_once 'subHeader02.php';?>
<style>#panel-18 .thumbnail-overlay{display: block;}</style>

<div class="frame">

  <div class="bit-1">
    <div class="box" id="description">
      <p><span class="titlePG">Width</span> is a two-player game in which you must defeat your opponents by clicking to take over the screen. Made only using JavaScript.</p>
      <p class="titleSub">JavaScript<span class="yellow"> . </span>Side Project<span class="yellow"> . </span>2016</p>
    </div>
  </div>

  <div class="bit-1">
    <div class="project-btn" id="project">
      <a href="http://juliomontas.com/width/" target="_blank">Visit the site</a>
    </div>
  </div>
  ...
  <div class="bit-1">
    <div class="work04 languageDetails" id="project">
      <ul>
        <li><b>JavaScript:</b>38.6%</li>
        <li><b>CSS:</b>36.9%</li>
        <li><b>HTML:</b>24.5%</li>
      </ul>
      <a href="https://github.com/JulioMontas/Javascript-Game-Width" target="_blank">View the code</a>
    </div>
